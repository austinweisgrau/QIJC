...
Revision ID: 9776c87d1f1c
Revises: 6e7ef5abd695
Create Date: 2020-06-10 13:31:58.945549
...
revision = '9776c87d1f1c'
down_revision = '6e7ef5abd695'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('password_hold', sa.String(length=128), nullable=True),
...
def downgrade():
    ...
    sa.Column('password_hold', sa.TEXT(), nullable=True),
