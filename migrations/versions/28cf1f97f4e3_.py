...
Revision ID: 28cf1f97f4e3
Revises: 4e7aa38ba561
Create Date: 2020-06-09 11:32:04.329115
...
revision = '28cf1f97f4e3'
down_revision = '4e7aa38ba561'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('voted', sa.String(length=128), nullable=True),
